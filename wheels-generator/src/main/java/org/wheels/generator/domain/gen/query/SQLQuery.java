 ...
 */
package org.wheels.generator.domain.gen.query;

import org.jetbrains.annotations.NotNull;
import org.wheels.generator.domain.gen.config.DbType;
import org.wheels.generator.domain.gen.config.IDbQuery;
import org.wheels.generator.domain.gen.config.ITypeConvert;
import org.wheels.generator.domain.gen.config.builder.ConfigBuilder;
import org.wheels.generator.domain.gen.config.builder.Entity;
import org.wheels.generator.domain.gen.config.po.TableField;
import org.wheels.generator.domain.gen.config.po.TableInfo;
import org.wheels.generator.domain.gen.config.querys.DbQueryDecorator;
import org.wheels.generator.domain.gen.jdbc.DatabaseMetaDataWrapper;
import org.wheels.generator.domain.gen.config.rules.IColumnType;
    ...
    protected void convertTableFields(@NotNull TableInfo tableInfo) {
        ...
        try {
            ...
            dbQuery.execute(tableFieldsSql, result -> {
                ...
                boolean isId = result.isPrimaryKey();
                // 处理ID
                if (isId) {
