 ...
 */
package org.wheels.generator.domain.gen.config.querys;
...
import org.wheels.generator.domain.gen.config.po.LikeTable;
...
public class DbQueryDecorator extends AbstractDbQuery {
    ...
    public String tablesSql() {
        ...
        if (DbType.POSTGRE_SQL == dbType || DbType.ORACLE == dbType) {
